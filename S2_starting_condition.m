function [matrix_of_healthy_people] = S2_starting_condition(population_size,percentage_initial_infected,infection_probability)
    ...
    days_after_first_vaccination = 0;
    is_infected_after_first_vaccine = 0;
    ...
    for i = 1:number_of_healthy_people
        ...
        before_infected = 0;
        is_vaccinated = 0;
        new_row = [x_coordinate,y_coordinate,before_infected, is_vaccinated,infection_probability,days_after_first_vaccination,is_infected_after_first_vaccine];
