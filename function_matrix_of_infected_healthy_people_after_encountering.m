    ...
    for i = 1:number_of_rows
        ...
        for j = 1:number_of_healthy_people
            ...
            if (matrix_of_healthy_people(j,1) == matrix_of_encounters(i,1)) && (matrix_of_healthy_people(j,2) == matrix_of_encounters(i,2)) && control == 0 %do they have same coords?
                ...
                if matrix_of_healthy_people(j,3) == 0  %is it infected before?
                    randomization_for_isolation_after_infection = rand;

                    
                    if matrix_of_healthy_people (j,4) == 1 %is it vaccinated before?

                        randomization_for_infection_after_vaccination_probability = rand;
                        ...
                        if(randomization_for_infection_after_vaccination_probability <= infection_probability_healthy_vaccinated )
                                ...
                                if(randomization_for_isolation_after_infection <= isolation_probability)
                                    is_isolated = 1;
                                else
                                    is_isolated = 0;
                                end
                                ...
                                new_row = [matrix_of_encounters(i,1),matrix_of_encounters(i,2),duration,is_vaccinated,is_isolated];
